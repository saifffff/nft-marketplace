...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("NFT"); // gets the ABI
  const nft = await NFT.deploy(); //when called on ABI fetchs the deployed copy of the contract instance
